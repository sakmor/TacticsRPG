...
public class GameManager : MonoBehaviour {
    ...
    void Update () {
        ...
        Camera.transform.position = Vector3.Lerp(Camera.transform.position, new Vector3(CameraChaseObject.transform.position.x, CameraChaseObject.transform.position.y, CameraChaseObject.transform.position.z+5f), Time.fixedDeltaTime *1f );
